...
exports.uploadImageBufferData = (filename,buffer) => {
  ...
  console.log(new Date().toLocaleString(),`Setting up S3 upload parameters => object uploadParams=`,uploadParams);
...
exports.uploadSelfie = (file) => {
  ...
  console.log(new Date().toLocaleString(),`fs.createReadStream(file.path) => fileStream=`,fileStream);
